...
legend_position = ["best", "best", "best", "best", "center right"]
...
for plot_value, vals, position in zip(unique_plots, cur_plot, legend_position): # strings, [0.25, H]...
    ...
    # test
    # plt.tight_layout()
    # plt.savefig(f"/home/uribe055/experiment-kit/round2/all_final_figs/test/5a_{plot_value}.png")  # Save the plot to a file
    # plt.close(fig)

    # # final
    plt.tight_layout()
    plt.savefig(f"/home/uribe055/experiment-kit/round2/all_final_figs/a/5a_{plot_value}.eps")  # Save the plot to a file
    plt.close(fig)
